...
1. Repositories `r fontawesome::fa("code-branch", fill = "#FF961C")`

--

1. Libri `r fontawesome::fa("book", fill = "#FF961C")`

--

1. Articoli `r fontawesome::fa("copy", fill = "#FF961C")`

--

1. Siti `r fontawesome::fa("file", fill = "#FF961C")`

--

1. Miscellaneous `r fontawesome::fa("stream", fill = "#FF961C")`
